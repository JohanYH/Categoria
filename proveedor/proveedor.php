  ...
  <div class="contenedor">
    ...
    <div class="parte-media">
      <div style="display: flex; justify-content: space-between;">
        <h2>Proveedores</h2>
        <button class="btn-m" data-bs-toggle="modal" data-bs-target="#registarProveedor"><i class="bi bi-person-add " style="color: rgb(255, 255, 255);" ></i></button>
      </div>
          ...
          <tbody class="" id="tabla">
            ...
            <tr>
              ...
              <td>
                <?php
                if (condition) {
                  echo '<a class="btn btn-danger" href="borrarProveedor.php?Proveedor_Id=<?=$val["Proveedor_Id"]?>&req=delete">Borrar</a>';
                }else {
                  # code...
                }
                ?>
    ...
    <div class="modal fade" id="registarProveedor" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="backdrop-filter: blur(5px)">
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" >
        <div class="modal-content" >
          ...
          <div class="modal-body" style="background-color: rgb(231, 253, 246);">
            <form class="col d-flex flex-wrap" action="registarProveedor.php" method="post">
