...
$datos ->setCliente_Id($Cliente_Id);
$record = $datos->selectOneCliente();
$val = $record[0];


if (isset($_POST["editar"])) {
    $datos->setCelular($_POST["Celular"]);
    $datos ->setCompañia($_POST["Compañia"]);

    $datos->updateCliente();
    echo "<script>alert('Los Datos Editados ha sido Exitosamente');document.location='../Clientes/clientes.php'</script>";
